...
### This exercise should be implemented in react framework

## The problem

The problem consists in rendering events on a calendar, avoiding overlapping events to visually overlap.
the implementation should meet the two following constraints:
...
The top of the page represents 08:00 am. The bottom of the page represents 09:00 pm.
